...
public class chart_dispalay extends javax.swing.JPanel {
    ...
    public void showChart(String Title, String xAxisTitle, String yAxisTitle, String seriesName, List<String> xData, List<Double> yData,String title2,int avg) {
    ...
    public void showLessonProgressPie(String Title,String title2,Double percent, int completed, int notcompleted,String s1,String s2) {
        ...
        pie.addSeries(s1, completed);
        pie.addSeries(s2, notcompleted);
