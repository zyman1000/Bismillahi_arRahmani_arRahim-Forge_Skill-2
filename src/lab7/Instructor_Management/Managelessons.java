   ...
   /* int r = lessons.getSelectedRow();
    ...
    if (lesson.hasQuiz()) {
        ...
        if (choice == JOptionPane.NO_OPTION) {
            ...
            Add_new_question_frame addQuestionFrame = new Add_new_question_frame(newQuiz);
            addQuestionFrame.setVisible(true);
            addQuestionFrame.setLocationRelativeTo(this);
            return;
        }
    ...
    lesson.getQuiz().setCourseId(courseId);
    AddQuiz_fram addQuizFrame = new AddQuiz_fram(instructor, manager.getCoursebyid(courseId), lesson, lesson.getQuiz());
